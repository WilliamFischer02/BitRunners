# setup-mega3.ps1 -- one-shot environment bootstrap + Claude Code launch
# for BitRunners mega-batch 3 (transmission face, VFX tune, appearance
# sync, void netcode, scrape tutorial, asset pipeline, Data Base, RAMHATTAN).
#
# RUN AS ADMINISTRATOR. Usage:
#   powershell -ExecutionPolicy Bypass -File .\setup-mega3.ps1   (works from 5.1 or 7)
...
#      max thinking budget, seeded with mega3-prompt.md (whose first
...
$branch = "claude/mega3-$(Get-Date -Format yyyy-MM-dd)"
