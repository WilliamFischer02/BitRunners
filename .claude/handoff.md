...
- **Active plan:** 5-chunk sprint in `docs/devlog/0039`. **Chunk A merged (PR #36); Chunk B = PR #37 (pending); Chunk C done (devlog 0041), its own PR pending.** D–E queued. Chunk C unblocked: SAMM lore recorded (008). Next: Chunk D (trade offers on depots/ports — no blocking Q&A) or Chunk E (tutorial + server_speaker unlock).
