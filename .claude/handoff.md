...
- **Active plan:** 5-chunk sprint in `docs/devlog/0039`. **Chunk A merged (PR #36); Chunk B done (devlog 0040), its own PR pending.** C–E queued. Open Q&A before Chunk C: the vending NPC's name/personality (lore).
